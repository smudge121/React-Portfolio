              ...
              <div className='row mt-3'>
                <form>
                  ...
                  <div className="form-group d-flex flex-column justify-content-center align-items-center mb-3">
                    ...
                    <textarea rows="5" className="form-control-custom w-50 dark-grey montserrat p-3" id="message" placeholder="Message of Email" ></textarea>
                  </div>
                  <button type="submit" className="rounded-circle p-3 btn-custom h2 dancing">Submit</button>
                </form>
              </div>
            </div>
          </div>
